...
// Icons
#define ICON_BUILD     ICON_MS_BUILD
#define ICON_CHARSET   ICON_MS_FONT_DOWNLOAD
#define ICON_COSTUME   ICON_MS_ACCESSIBILITY_NEW
#define ICON_EDIT      ICON_MS_EDIT
...
#define ICON_ROOM      ICON_MS_DOOR_FRONT
#define ICON_SCREEN    ICON_MS_MONITOR
#define ICON_SCRIPT    ICON_MS_CODE
#define ICON_BACK      ICON_MS_ARROW_BACK
#define ICON_SAVE      ICON_MS_SAVE
#define ICON_VISIBLE   ICON_MS_VISIBILITY

// Animation control icons
#define ICON_PLAY      ICON_MS_PLAY_ARROW
#define ICON_PAUSE     ICON_MS_PAUSE
#define ICON_STOP      ICON_MS_STOP
#define ICON_STEP_BACK ICON_MS_SKIP_PREVIOUS
#define ICON_STEP_FWD  ICON_MS_SKIP_NEXT
